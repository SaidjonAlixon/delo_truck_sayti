          ...
          <div className="flex flex-wrap gap-6 lg:gap-8 items-start">
            ...
            >
              <button className="flex items-center gap-1 font-semibold mb-2 text-sm text-background hover:text-primary transition-colors">
                ...
                <ChevronDown className={`w-4 h-4 transition-transform ${hoveredSection === "services" ? "rotate-180" : ""}`} />
              </button>
              <ul className={`space-y-1 text-xs text-background/80 overflow-hidden transition-all duration-300 ${hoveredSection === "services" ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
                <li>
                  <button 
            ...
            >
              <button className="flex items-center gap-1 font-semibold mb-2 text-sm text-background hover:text-primary transition-colors">
                Quick Links
                <ChevronDown className={`w-4 h-4 transition-transform ${hoveredSection === "links" ? "rotate-180" : ""}`} />
              </button>
              <ul className={`space-y-1 text-xs text-background/80 overflow-hidden transition-all duration-300 ${hoveredSection === "links" ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
                <li>
                  <button 
                    onClick={() => scrollToSection("services")}
                    className="hover:text-primary transition-colors text-left"
            ...
            >
              <button className="flex items-center gap-1 font-semibold mb-2 text-sm text-background hover:text-primary transition-colors">
                Contact
                <ChevronDown className={`w-4 h-4 transition-transform ${hoveredSection === "contact" ? "rotate-180" : ""}`} />
              </button>
              <ul className={`space-y-1.5 text-xs text-background/80 overflow-hidden transition-all duration-300 ${hoveredSection === "contact" ? "max-h-96 opacity-100" : "max-h-0 opacity-0"}`}>
